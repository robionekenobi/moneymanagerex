    ...
    : wxWizardPageSimple(parent)
{
    ...
    if (base_currency) {
        ...
        PrefModel::instance().saveBaseCurrencyID(currencyID_);
    }
...
bool mmNewDatabaseWizardPage::TransferDataFromWindow()
{
    ...
    PrefModel::instance().saveUserName(userName);
...
void mmNewDatabaseWizardPage::OnCurrency(wxCommandEvent& /*event*/)
{
    while (true) {
        ...
        const CurrencyData* currency = CurrencyModel::instance().get_idN_data_n(currencyID_);
        if (currency) {
