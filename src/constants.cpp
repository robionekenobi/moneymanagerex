...
const wxString FOLDER_DOCUMENTS = "%DOCUMENTS%";
const wxString FOLDER_DATABASE = "%DATABASE%";
const wxString FOLDER_USERPROFILE = "%USERPROFILE%";
const wxString FOLDER_APPDATA = "%APPDATA%";
