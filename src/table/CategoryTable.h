...
struct CategoryCol
{
    ...
    static const wxString NAME_CATEGNAME;
    ...
    static TableClauseV<wxString> WHERE_CATEGNAME(OP op, const wxString& value) {
        return TableClause::WHERE<wxString>(NAME_CATEGNAME, op, value);
    }
    ...
    struct CATEGNAME : public TableOpV<wxString>
    {
        ...
        static wxString col_name() { return s_col_name_a[COL_ID_CATEGNAME]; }
