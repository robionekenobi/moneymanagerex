...
struct SchedCol
{
    ...
    static const wxString NAME_BDID;
    ...
    static const wxString NAME_REPEATS;
    static const wxString NAME_NEXTOCCURRENCEDATE;
    static const wxString NAME_NUMOCCURRENCES;
    static const wxString NAME_COLOR;

    // convenience methods

    static TableClauseV<int64> WHERE_BDID(OP op, const int64& value) {
        return TableClause::WHERE<int64>(NAME_BDID, op, value);
    }
    ...
    static TableClauseV<int64> WHERE_REPEATS(OP op, const int64& value) {
        return TableClause::WHERE<int64>(NAME_REPEATS, op, value);
    }

    static TableClauseV<wxString> WHERE_NEXTOCCURRENCEDATE(OP op, const wxString& value) {
        return TableClause::WHERE<wxString>(NAME_NEXTOCCURRENCEDATE, op, value);
    }

    static TableClauseV<int64> WHERE_NUMOCCURRENCES(OP op, const int64& value) {
        return TableClause::WHERE<int64>(NAME_NUMOCCURRENCES, op, value);
    }
    ...
    struct BDID : public TableOpV<int64>
    {
        ...
        static wxString col_name() { return s_col_name_a[COL_ID_BDID]; }
    ...
    struct REPEATS : public TableOpV<int64>
    {
        ...
        static wxString col_name() { return s_col_name_a[COL_ID_REPEATS]; }
    ...
    struct NEXTOCCURRENCEDATE : public TableOpV<wxString>
    {
        ...
        static wxString col_name() { return s_col_name_a[COL_ID_NEXTOCCURRENCEDATE]; }
    ...
    struct NUMOCCURRENCES : public TableOpV<int64>
    {
        ...
        static wxString col_name() { return s_col_name_a[COL_ID_NUMOCCURRENCES]; }
