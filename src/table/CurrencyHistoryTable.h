...
struct CurrencyHistoryCol
{
    ...
    static const wxString NAME_CURRHISTID;
    static const wxString NAME_CURRENCYID;
    static const wxString NAME_CURRDATE;
    static const wxString NAME_CURRVALUE;
    static const wxString NAME_CURRUPDTYPE;

    // convenience methods

    static TableClauseV<int64> WHERE_CURRHISTID(OP op, const int64& value) {
        return TableClause::WHERE<int64>(NAME_CURRHISTID, op, value);
    }
    ...
    static TableClauseV<wxString> WHERE_CURRDATE(OP op, const wxString& value) {
        return TableClause::WHERE<wxString>(NAME_CURRDATE, op, value);
    }

    static TableClauseV<double> WHERE_CURRVALUE(OP op, const double& value) {
        return TableClause::WHERE<double>(NAME_CURRVALUE, op, value);
    }

    static TableClauseV<int64> WHERE_CURRUPDTYPE(OP op, const int64& value) {
        return TableClause::WHERE<int64>(NAME_CURRUPDTYPE, op, value);
    }
    ...
    struct CURRHISTID : public TableOpV<int64>
    {
        ...
        static wxString col_name() { return s_col_name_a[COL_ID_CURRHISTID]; }
    ...
    struct CURRDATE : public TableOpV<wxString>
    {
        ...
        static wxString col_name() { return s_col_name_a[COL_ID_CURRDATE]; }
    ...
    struct CURRVALUE : public TableOpV<double>
    {
        ...
        static wxString col_name() { return s_col_name_a[COL_ID_CURRVALUE]; }
    ...
    struct CURRUPDTYPE : public TableOpV<int64>
    {
        ...
        static wxString col_name() { return s_col_name_a[COL_ID_CURRUPDTYPE]; }
