...
const wxArrayString TrxShareCol::s_col_name_a = {
    "SHAREINFOID",
    "CHECKINGACCOUNTID",
    "SHARENUMBER",
    "SHAREPRICE",
...
const TrxShareCol::COL_ID TrxShareCol::s_primary_id = COL_ID_SHAREINFOID;
const wxString TrxShareCol::s_primary_name = s_col_name_a[COL_ID_SHAREINFOID];

// convenience variables
const wxString TrxShareCol::NAME_SHAREINFOID = s_col_name_a[COL_ID_SHAREINFOID];
const wxString TrxShareCol::NAME_CHECKINGACCOUNTID = s_col_name_a[COL_ID_CHECKINGACCOUNTID];
const wxString TrxShareCol::NAME_SHARENUMBER = s_col_name_a[COL_ID_SHARENUMBER];
const wxString TrxShareCol::NAME_SHAREPRICE = s_col_name_a[COL_ID_SHAREPRICE];
const wxString TrxShareCol::NAME_SHARECOMMISSION = s_col_name_a[COL_ID_SHARECOMMISSION];
const wxString TrxShareCol::NAME_SHARELOT = s_col_name_a[COL_ID_SHARELOT];
