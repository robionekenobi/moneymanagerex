...
void CurrencyManager::createControls()
{
    ...
    itemFlexGridSizer3->Add(
        new wxStaticText(this, wxID_STATIC, _t("Currency Symbol")),
        g_flagsH
    );
    ...
    itemFlexGridSizer3->Add(
        new wxStaticText(this, wxID_STATIC, _t("Symbol Location")),
        g_flagsH
    );
    w_prefix = new wxRadioButton(this, ID_DIALOG_CURRENCY,
        _t("Prefix"),
        wxDefaultPosition, wxDefaultSize,
        wxRB_GROUP
    );
    w_suffix = new wxRadioButton(this, ID_DIALOG_CURRENCY,
        _t("Suffix"),
        wxDefaultPosition, wxDefaultSize
    );
    ...
    itemFlexGridSizer3->Add(
        new wxStaticText(this, wxID_STATIC, _t("Grouping Char")),
        g_flagsH
    );
    ...
    w_scale = new wxTextCtrl(this, ID_DIALOG_CURRENCY,
        "",
        wxDefaultPosition, wxDefaultSize,
        wxALIGN_RIGHT,
        valInt
    ...
    itemFlexGridSizer3->Add(
        new wxStaticText(this, wxID_STATIC, _t("Conversion to Base Rate")),
        g_flagsH
    );
    ...
    w_baseConvRate->Connect(
        ID_DIALOG_CURRENCY_RATE, wxEVT_COMMAND_TEXT_ENTER,
        wxCommandEventHandler(CurrencyManager::onTextEntered),
        nullptr, this
    );
    ...
    //--------------------------
    wxStaticBox* itemStaticBox_01 = new wxStaticBox(this, wxID_STATIC,
        _t("Currency Format Sample:")
    );
    wxStaticBoxSizer* itemStaticBoxSizer_01 = new wxStaticBoxSizer(itemStaticBox_01,
        wxHORIZONTAL
    );
