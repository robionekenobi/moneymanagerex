...
wxBEGIN_EVENT_TABLE(AttachmentPref, wxPanel)
    EVT_BUTTON(ID_DIALOG_OPTIONS_BUTTON_ATTACHMENTSFOLDER, AttachmentPref::OnAttachmentsButton)
    EVT_TEXT(ID_DIALOG_OPTIONS_TEXTCTRL_ATTACHMENT, AttachmentPref::OnAttachmentsPathChanged)
    EVT_CHECKBOX(ID_DIALOG_OPTIONS_CHECKBOX_ATTACHMENTSSUBFOLDER, AttachmentPref::OnAttachmentsSubfolderChanged)
wxEND_EVENT_TABLE()
/*******************************************************/

AttachmentPref::AttachmentPref()
{
}

AttachmentPref::AttachmentPref(wxWindow *parent
    , wxWindowID id
    , const wxPoint &pos
    , const wxSize &size
